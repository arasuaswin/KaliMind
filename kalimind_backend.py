...
def health_check():
    ...
    return jsonify({
        "status": "healthy",
    "message": "KaliMind API Server is running",
...
@app.route("/mcp/tools/kalimind_tools/<tool_name>", methods=["POST"])
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Run the KaliMind API Server")
...
if __name__ == "__main__":
    ...
    logger.info(f"Starting KaliMind API Server on {args.ip}:{API_PORT}")
